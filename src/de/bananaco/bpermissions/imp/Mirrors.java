...
public class Mirrors {
     ...
     * plugins/bPermissions/mirrors.yml No nested values, simply keyed like so -
     * all these would be mirrored to the object "world" world_nether: world
     * world_end: world world_economy: world
     */
    public void load() {
        try {
            if (!file.exists()) {
